...
const ActivityLog: React.FC<ActivityLogProps> = ({ actions }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md border h-full border-gray-200 p-4">
      ...
      <div className="space-y-3 max-h-96 overflow-y-auto">
        {actions.length === 0 ? (
          ...
          actions.map((action) => (
            <div key={action._id} className="flex items-start space-x-3 p-2 hover:bg-gray-50 rounded-sm">
